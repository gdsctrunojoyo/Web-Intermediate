...
<html>
  <head>
    ...
    <!-- Lightbox-->
    <link rel="stylesheet" href="{{ url('vendor/lightbox2/css/lightbox.min.css') }}">
    <!-- Range slider-->
    ...
    <!-- Owl Carousel-->
    <link rel="stylesheet" href="{{ url('vendor/owl.carousel2/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ url('vendor/owl.carousel2/assets/owl.theme.default.css') }}">
    <!-- Google fonts-->
          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="{{ route('index') }}"><span class="font-weight-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link" href="{{ route('shop.index') }}">Shop</a>
                </li>
